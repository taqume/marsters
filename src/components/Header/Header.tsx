      ...
      <div className="container mx-auto px-6 py-3">
        ...
        <div className="flex items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-4 group flex-shrink-0">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-slate-600 via-sky-600 to-slate-700 dark:from-slate-300 dark:via-sky-300 dark:to-slate-400 bg-clip-text text-transparent drop-shadow-sm">
                {t('header.title')}
              </h1>
              <p className="text-[10px] text-slate-600 dark:text-slate-400 font-mono tracking-wider uppercase">{t('header.tagline')}</p>
            </div>
          </div>
