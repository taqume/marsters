import { ThemeMode } from '@models/Article';
 ...
 * Renders the realistic space background with stars, nebulae, planets, and meteors
 * Extracted from App.tsx for better modularity
 */
export const SpaceBackground: React.FC<SpaceBackgroundProps> = ({ theme }) => {
  return (
    <div className="fixed inset-0 pointer-events-none">
      ...
      <div className="absolute inset-0 opacity-5 dark:opacity-15">
        ...
        {[
          { color: theme === ThemeMode.DARK ? 'rgba(147, 51, 234, 0.4)' : 'rgba(251, 191, 36, 0.3)', top: '60%', left: '15%', size: '400px' },
          { color: theme === ThemeMode.DARK ? 'rgba(59, 130, 246, 0.3)' : 'rgba(245, 158, 11, 0.2)', top: '25%', left: '70%', size: '350px' },
          { color: theme === ThemeMode.DARK ? 'rgba(236, 72, 153, 0.3)' : 'rgba(251, 146, 60, 0.2)', top: '75%', left: '80%', size: '300px' },
        ].map((nebula, i) => (
          <div
            key={`nebula-${i}`}
          ...
          return (
            <div
              ...
              style={{
                ...
                top: topPos + '%',
                left: leftPos + '%',
                backgroundColor: theme === ThemeMode.DARK ? '#ffffff' : '#fbbf24',
                boxShadow: theme === ThemeMode.DARK 
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '50%',
              border: theme === ThemeMode.DARK ? '3px solid rgba(139, 92, 246, 0.7)' : '3px solid rgba(245, 158, 11, 0.7)',
              boxShadow: theme === ThemeMode.DARK
